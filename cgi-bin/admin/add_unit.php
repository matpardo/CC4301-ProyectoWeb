...
<html>
	...
	<div id="wrap">
      ...
      <div class="container">
        ...
        <p class="lead">Adding a unit.</p>
  
        <hr>

        <form action="add_unit_submit.php" name="add_unit" id="add_unit" accept-charset="UTF-8" method="POST" enctype="multipart/form-data" class='navbar-form pull-left'>
			<fieldset>
				<p>
